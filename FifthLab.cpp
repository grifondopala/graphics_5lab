...
void saveImage(Mat* image, string name) {
    imwrite("D:/MEPHI/KG/FifthLab/FifthLab/FifthLab/result/" + name, *image);
}
...
void rotateXYProjection() {
    ...
    while (angle < PI * 2) {
        ...
        saveImage(&image, "default_rotate/rotate" + to_string(angle) + ".png");
...
void rotatePointProjection(double r) {
    ...
    while (angle < PI * 2) {
        ...
        saveImage(&image, "point_rotate/rotate" + to_string(angle) + ".png");
